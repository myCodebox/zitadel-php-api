...
use ZitadelPhpApi\User\Account;
use ZitadelPhpApi\User\Create;
use ZitadelPhpApi\User\Delete;
use ZitadelPhpApi\User\Edit;
use ZitadelPhpApi\User\Email;
use ZitadelPhpApi\User\Get;
use ZitadelPhpApi\User\Phone;
...
class UserTest extends TestCase
{
    ...
    public function testUserCreate()
    {
        ...
        $create_user->setPhone("+49170123456789", true);
